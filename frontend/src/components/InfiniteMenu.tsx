...
const InfiniteMenu: FC<InfiniteMenuProps> = ({ items = [], onActiveItemChange }) => {
  ...
  useEffect(() => {
    ...
    const handleActiveItem = (index: number) => {
      ...
      // استدعاء callback function من parent component
  ...
  const handleButtonClick = () => {
    ...
    console.log('Selected cryptocurrency:', activeItem.title);
    // يمكنك إضافة action مختلف هنا حسب العملة المختارة
  };
